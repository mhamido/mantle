...
//       JsonCodecMaker.make(CodecMakerConfig.withAllowRecursiveTypes(true))
  ...
  object Arg:
    ...
    case class Type(name: self.Type)(using val info: Info) extends Arg
    case class Value(value: Expr)(using val info: Info)    extends Arg

  sealed trait Pattern extends Tagged
  object Pattern:
    export Value.*
    case class Wildcard()(using val info: Info) extends Pattern
    case class Constr(name: Name, typeArgs: Seq[Type], args: Option[Pattern])(
        using val info: Info
    ) extends Pattern

    case class Tuple(elems: Seq[Pattern])(using val info: Info) extends Pattern
    case class Ascribe(pattern: Pattern, tpe: Type)(using val info: Info)
        extends Pattern
  ...
  object Decl:
    ...
    case class Val(binder: Pattern, body: Expr)(using
  ...
  object Value:
    ...
    case class Var(name: Name)(using val info: Info)              extends Value
